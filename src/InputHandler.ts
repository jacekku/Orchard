...
export class InputHandler {
    ...
    fireEvent(event: ExtendedEvent) {
        const affectedObjects: Array<GameEventListener> = this.registry.registry[event.eventType] || [];
        affectedObjects.forEach((object : GameEventListener) => object.eventFired(event));
    }
}
